...
class TestPaymentTermCutoffDate(TransactionCase):
    ...
    def test_due_date_before_cutoff_day(self):
        """ Test if due date remains unchanged when invoice date is before or equal to cutoff date """
        ...
        self.assertEqual(computed_due_date, expected_due_date,)

    def test_due_date_after_cutoff_day(self):
        """ Test if due date is shifted by +1 month when invoice date is after cutoff date """
